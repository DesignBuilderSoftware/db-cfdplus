...
#include "alphatJayatillekeWallFunctionBCFDKFvPatchScalarField.H"
...
scalar alphatJayatillekeWallFunctionBCFDKFvPatchScalarField::maxExp_ = 50.0;
scalar alphatJayatillekeWallFunctionBCFDKFvPatchScalarField::tolerance_ = 0.01;
label alphatJayatillekeWallFunctionBCFDKFvPatchScalarField::maxIters_ = 10;

// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

scalar alphatJayatillekeWallFunctionBCFDKFvPatchScalarField::Psmooth
(
    const scalar Prat
) const
{
...
scalar alphatJayatillekeWallFunctionBCFDKFvPatchScalarField::yPlusTherm
(
...
alphatJayatillekeWallFunctionBCFDKFvPatchScalarField
(
    const alphatJayatillekeWallFunctionBCFDKFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
alphatJayatillekeWallFunctionBCFDKFvPatchScalarField
(
    const alphatJayatillekeWallFunctionBCFDKFvPatchScalarField& awfpsf
)
:
...
void alphatJayatillekeWallFunctionBCFDKFvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
...
void alphatJayatillekeWallFunctionBCFDKFvPatchScalarField::write(Ostream& os) const
{
