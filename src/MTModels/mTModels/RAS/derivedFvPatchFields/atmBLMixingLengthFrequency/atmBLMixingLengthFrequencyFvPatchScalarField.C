...
#include "atmBLMixingLengthFrequencyFvPatchScalarField.H"
...
atmBLMixingLengthFrequencyFvPatchScalarField
(
    const atmBLMixingLengthFrequencyFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
void atmBLMixingLengthFrequencyFvPatchScalarField::autoMap
(
...
void atmBLMixingLengthFrequencyFvPatchScalarField::rmap
(
...
)
{
    ...
    const atmBLMixingLengthFrequencyFvPatchScalarField& tiptf =
        refCast<const atmBLMixingLengthFrequencyFvPatchScalarField>
        (ptf);
...
void atmBLMixingLengthFrequencyFvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
    ...
    this->refValue() = sqrt(kp)/(Cmu25*mixingLength);
...
void atmBLMixingLengthFrequencyFvPatchScalarField::write
(
    Ostream& os
) const
{
