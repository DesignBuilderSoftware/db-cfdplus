...
#include "polynomialMixingLengthDissipationRateInletFvPatchScalarField.H"
...
polynomialMixingLengthDissipationRateInletFvPatchScalarField
(
    const polynomialMixingLengthDissipationRateInletFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
:
    ...
    z_(ptf.z_),
    mixingLength_(ptf.mixingLength_, false),
    kName_(ptf.kName_),
...
void polynomialMixingLengthDissipationRateInletFvPatchScalarField::autoMap
(
...
void polynomialMixingLengthDissipationRateInletFvPatchScalarField::rmap
(
...
)
{
    ...
    const polynomialMixingLengthDissipationRateInletFvPatchScalarField& tiptf =
        refCast<const polynomialMixingLengthDissipationRateInletFvPatchScalarField>
        (ptf);
...
void polynomialMixingLengthDissipationRateInletFvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
    ...
    this->refValue() = Cmu75*kp*sqrt(kp)/mixingLengthField;
...
void polynomialMixingLengthDissipationRateInletFvPatchScalarField::write
(
    Ostream& os
) const
{
