...
Foam::pointEntryList::pointEntryList
(
    const IOobject& io
)
:
    regIOobject(io),
    PtrList<pointZoneEntry>(readStream(typeName))
{
    close();
}
...
bool Foam::pointEntryList::writeData(Ostream& os) const
{
    os  << *this;
    return os.good();
}
